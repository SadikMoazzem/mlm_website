...
export default function AddPrayerTimesPage() {
  return (
        ...
        >
          ...
          <div 
            dangerouslySetInnerHTML={{
              __html: `
                <iframe
                  id="JotFormIFrame-251052136488355"
                  title="MyLocalMasjid Prayer times Form"
                  onload="window.parent.scrollTo(0,0)"
                  allowtransparency="true"
                  allow="geolocation; microphone; camera; fullscreen"
                  src="https://form.jotform.com/251052136488355"
                  frameborder="0"
          ...
          <Script id="jotform-handler">
            {`window.jotformEmbedHandler && window.jotformEmbedHandler("iframe[id='JotFormIFrame-251052136488355']", "https://form.jotform.com/")`}
          </Script>
        </motion.div>
      </motion.div>
    </main>
